...
pub mod family_identity {
    pub const HEAD_FAMILY: [u8; 32] = [
        50, 142, 114, 137, 51, 131, 132, 219, 119, 116, 167, 188, 152, 90, 168, 164, 6,
        226, 248, 143, 84, 209, 140, 128, 197, 161, 241, 119, 119, 249, 179, 204,
    ];
    pub const ENTRY_FAMILY: [u8; 32] = [
        132, 36, 60, 152, 250, 246, 211, 199, 7, 205, 232, 136, 240, 107, 29, 198, 222,
        185, 164, 205, 142, 192, 78, 120, 210, 82, 20, 97, 233, 233, 120, 161,
    ];
    pub const CHECKPOINT_FAMILY: [u8; 32] = [
        63, 54, 245, 76, 183, 31, 212, 202, 27, 164, 169, 145, 17, 205, 218, 71, 220, 49,
        67, 247, 137, 50, 250, 90, 208, 200, 212, 4, 97, 23, 161, 193,
    ];
    pub const RETENTION_FAMILY: [u8; 32] = [
        80, 61, 109, 143, 83, 118, 217, 74, 244, 198, 196, 75, 93, 255, 248, 108, 175,
        206, 114, 11, 53, 40, 13, 45, 48, 79, 78, 58, 45, 96, 138, 209,
    ];
}
