...
pub mod family_identity {
    pub const HEAD_FAMILY: [u8; 32] = [
        82, 175, 95, 153, 173, 29, 236, 15, 104, 141, 234, 244, 168, 154, 139, 244, 233,
        27, 117, 183, 82, 243, 166, 13, 155, 207, 148, 5, 182, 145, 57, 153,
    ];
    pub const ENTRY_FAMILY: [u8; 32] = [
        22, 234, 143, 81, 40, 134, 164, 245, 14, 105, 98, 225, 47, 1, 231, 114, 56, 11,
        86, 174, 238, 243, 220, 254, 243, 70, 213, 109, 182, 138, 57, 223,
    ];
    pub const CHECKPOINT_FAMILY: [u8; 32] = [
        224, 176, 98, 122, 127, 163, 224, 27, 124, 203, 91, 149, 4, 40, 186, 7, 161, 156,
        110, 114, 242, 109, 231, 215, 94, 158, 43, 58, 184, 78, 36, 71,
    ];
    pub const RETENTION_FAMILY: [u8; 32] = [
        56, 39, 143, 136, 110, 47, 43, 50, 106, 41, 20, 24, 187, 30, 252, 174, 176, 189,
        53, 124, 178, 117, 255, 71, 131, 206, 152, 13, 24, 35, 82, 122,
    ];
}
